...
#srun --pty --ntasks 4 --mem=64gb --qos=medium --gres=gpu:rtxa6000:1 --time=6:00:00 --account=nexus zsh
...
srun --pty --ntasks-per-node 4 --mem=48gb --qos=vulcan-medium --gres=gpu:rtxa6000:1 --time=4:00:00 --partition=vulcan-ampere --account=vulcan-jbhuang zsh
