...
for scene in "${scenes[@]}"; do
    for lr_weight in "${lr_weights[@]}"; do
        ...
        variation="fidelity_wt_1_lr_wt_${lr_weight}_iter_${NUM_ITERS}_0511"
...
#     "Tree-18"
#     "Yellowhouse-12"
#     )  # Example: "fern" "flower" "fortress" "horns" "orchids" "room" "trex"
...
#         # # Experiment variation
#         variation="SR_input_rendered_HR_from_LR_pretrained"

#         # Experiment directory (inside loop to change with each iteration)
#         exp_dir="/fs/nexus-projects/dyn3Dscene/Codes/mip-splatting-mine/outputs/${dataset_name}/proposed/load_DS_$((factors * 4))/train_proposed_DS_$((factors))_${variation}_0506"
...
#             --config /fs/nexus-projects/dyn3Dscene/Codes/StableSR/configs/stableSRNew/v2-finetune_text_T_512.yaml \
#             --ckpt /fs/nexus-projects/dyn3Dscene/Codes/StableSR/weights/stablesr_turbo.ckpt \
#             --init-img /fs/nexus-projects/dyn3Dscene/Codes/mip-splatting-mine/outputs/${dataset_name}/orig/input_DS_$((factors * 4))/${scene}/ours_30000/DS_1/train_preds_1 \
#             --outdir ${exp_dir}/${scene}/outputs_proposed_load_DS_$((factors * 4))/ \
#             --ddpm_steps 4 \
#             --dec_w 0.5 \
#             --seed 42 \
